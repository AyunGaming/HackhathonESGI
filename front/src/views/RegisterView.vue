          ...
          <div v-for="(vehicule, index) in vehicules" :key="index" class="mb-6 p-4 border rounded-lg shadow-sm">
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div>
                ...
                <p v-if="errors.vehicules[index] && errors.vehicules[index].brand" class="text-red-500 text-xs mt-1">{{ errors.vehicules[index].brand }}</p>
              </div>
              <div>
                ...
                <p v-if="errors.vehicules[index] && errors.vehicules[index].model" class="text-red-500 text-xs mt-1">{{ errors.vehicules[index].model }}</p>
              </div>
              <div>
                ...
                <p v-if="errors.vehicules[index] && errors.vehicules[index].registration" class="text-red-500 text-xs mt-1">{{ errors.vehicules[index].registration }}</p>
              </div>
              <div>
                ...
                <p v-if="errors.vehicules[index] && errors.vehicules[index].vin" class="text-red-500 text-xs mt-1">{{ errors.vehicules[index].vin }}</p>
              </div>
              <div>
                ...
                <p v-if="errors.vehicules[index] && errors.vehicules[index].circulation_date" class="text-red-500 text-xs mt-1">{{ errors.vehicules[index].circulation_date }}</p>
              </div>
              <div>
                ...
                <p v-if="errors.vehicules[index] && errors.vehicules[index].mileage" class="text-red-500 text-xs mt-1">{{ errors.vehicules[index].mileage }}</p>
              </div>
            </div>
        ...
        <div v-if="conducteurDiff" class="mt-6 space-y-4">
          ...
          <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div>
              ...
              <p v-if="errors.driver_last_name" class="text-red-500 text-xs mt-1">{{ errors.driver_last_name }}</p>
            </div>
            <div>
              ...
              <p v-if="errors.driver_first_name" class="text-red-500 text-xs mt-1">{{ errors.driver_first_name }}</p>
            </div>
            <div>
              ...
              <p v-if="errors.driver_phone" class="text-red-500 text-xs mt-1">{{ errors.driver_phone }}</p>
            </div>
          </div>
        </div>
